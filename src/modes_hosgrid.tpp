...
void modes_hosgrid::populate_hos_vel(
    ReadModes<VT> rm_obj, const double z, const double zsl,
    std::vector<VT> mX_vector, std::vector<VT> mY_vector,
    std::vector<VT> mZ_vector, std::vector<fftw_plan> p_vector,
  ...
  populate_hos_vel(
      ...
      rm_obj.get_L(), rm_obj.get_T(), mX_vector, mY_vector, mZ_vector, p_vector,
